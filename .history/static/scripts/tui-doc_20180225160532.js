...
function toggleSubNav(e) {
    $(e.currentTarget).sblings().toggleClass('hidden');
    $(e.currentTarget).find('.fa').toggleClass('fa-plus-square fa-minus-square');
}

$mynav.find('.lnb-api').each(function() {
